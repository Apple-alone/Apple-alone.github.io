...
export const siteConfig: SiteConfig = {
	// 站点 URL（以斜杠结尾）
	siteURL: "https://www.applesaber.site/", // 请替换为你的站点 URL 并以斜杠结尾
	// 站点标题
	title: "Applesaber的小站",
	// 站点副标题
	subtitle: "Applesaber Blog",
	// 语言配置
	...
	wallpaper: {
		...
		src: {
			...
			desktop: [
				"/assets/images/desktopWallpaper_1.png",
				"/assets/images/desktopWallpaper_2.png",
				"/assets/images/desktopWallpaper_3.png",
			],
			// 移动壁纸图片 (相对于 /public 目录; 支持单张图片或图片数组，当数组长度 > 1 时自动启用轮播)
			mobile: [
				"/assets/images/mobileWallpaper_1.png",
				"/assets/images/mobileWallpaper_2.png",
			],
		},
		...
		banner: {
			...
			homeText: {
				...
				enable: true,
				// 主标题
				title: "Applesaber Blog",
				// 副标题，支持单个字符串或字符串数组
				subtitle: ["Music Saving The World"],
				// 副标题打字机效果
				typewriter: {
					// 启用副标题打字机效果
					enable: true,
	...
	links: [
		...
		LinkPreset.Archive,
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Apple-alone",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/674955246",
					external: true,
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		welcome: "欢迎！",
		// 触摸提示
		touch: ["在做什么呢？", "请不要再摸我了>_<！", "别欺负我！", "嗯~"],
		// 首页提示
		home: "请点这里回家！",
		// 换装提示
		skin: ["想看看我的新衣服吗？", "“新衣服看起来很好看哦~"],
		// 关闭提示
		close: "下次再见~",
		// 关于链接
